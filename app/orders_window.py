...
class OrdersWindow:
    ...
    def load_orders(self):
        ...
        for row_idx, row in enumerate(orders):
            ...
            self.create_order_card(row_idx, order_id, article, status, pickup_address, order_date, delivery_date or "Не назначена")
    
    def create_order_card(self, index, order_id, article, status, pickup_address, order_date, delivery_date):
