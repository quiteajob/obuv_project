...
class EditProductWindow:
    def __init__(self, root, user, product_id, resources_path, on_close=None):
        ...
        # Заголовок
        header = tk.Frame(
            self.scrollable_frame, bg=COLOR_ACCENT_BG
        )  # ← Изменено: self.scrollable_frame
    ...
    def create_form(self):
        ...
        self._create_field(
            ...
            width=20,
            required=True,
            default=article if article else "",
        ...
        self.quantity_var.set(
            str(stock_quantity) if stock_quantity is not None else "0"
        )
            ...
            if image_path:
                ...
                if img_path.exists():
                    ...
                    self.photo_label = tk.Label(
                        self.photo_container, image=photo, bg="#F0F0F0"
                    )
    ...
    def upload_photo(self):
        ...
        try:
            ...
            self.photo_label = tk.Label(self.photo_container, image=photo, bg="#F0F0F0")
            self.photo_label.image = photo
            self.photo_label.pack(fill=tk.BOTH, expand=True)
        ...
        try:
            ...
            data = {
                ...
                "image_path": (
                    ...
                    else self.original_image_path or ""
                ),
            }
