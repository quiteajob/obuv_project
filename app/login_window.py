...
class LoginWindow:
    def __init__(self, root):
        ...
        # Логин
        tk.Label(form_frame, text="Логин:", font=(FONT_FAMILY, FONT_SIZE + 2), bg=COLOR_MAIN_BG).pack(anchor="w")
        self.login_entry = tk.Entry(form_frame, font=(FONT_FAMILY, FONT_SIZE + 2), width=40)
        ...
        # Пароль
        tk.Label(form_frame, text="Пароль:", font=(FONT_FAMILY, FONT_SIZE + 2), bg=COLOR_MAIN_BG).pack(anchor="w", pady=(15, 5))
        self.password_entry = tk.Entry(form_frame, font=(FONT_FAMILY, FONT_SIZE + 2), width=40, show="*")
