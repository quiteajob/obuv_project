...
from database import (
    add_product, get_unique_categories, get_unique_manufacturers,
    get_unique_suppliers, get_next_product_id
)
...
class AddProductWindow:
    ...
    def _create_form_fields(self):
        ...
        self._create_field(
            ...
            width=15, required=True, default="шт.",
    ...
    def validate_form(self):
        ...
        if errors:
            error_text = "Обнаружены следующие ошибки:\n\n" + "\n".join(errors) + "\n\n" \
